...
public class ontime : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        if (changing == true)
        {
            polosa.transform.localPosition = Vector3.Lerp(polosa.transform.localPosition, new Vector3(polosa.transform.localPosition.x, 1.38f, 0), counter);
